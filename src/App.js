  ...
  render() {
    ...
    return (
      <div className="main-bg-con">
        ...
        <div className="img-play-again-con">
          {!isTrue && (
            <div className="div-1">
              <img className="main-img" src={imgUrl} alt="match" />
              <ul className="ul-list-tabs">
                {tabsList.map(eachItem => (
                  <li key={eachItem.tabId} className="li-tabs">
                    <button
                      type="button"
                      className={`btn ${
                        category === eachItem.tabId ? 'highlight-text' : ''
                      }`}
                      onClick={() => this.clickTab(eachItem.tabId)}
                    >
              ...
              <ul className="ul-img-list">
                {thumbnailList.map(eachImage => (
                  <li className="li-img-list" key={eachImage.id}>
                    <button
                      className="img-btn"
                      type="button"
